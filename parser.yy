...
procedure_definition:
	...
	if (NOT_ONLY_PARSE)
	{
		...
		string proc_name = *$1;
		//std::cout<<"function name : "<<proc_name<<endl;
...
assignment_statement:
	...
	if (NOT_ONLY_PARSE)
	{
		...
		Ast * lhs = $1;	
		Ast * rhs = $3;
		CHECK_INVARIANT(lhs->get_data_type()==rhs->get_data_type(), "lhs and rhs data type should be same");
